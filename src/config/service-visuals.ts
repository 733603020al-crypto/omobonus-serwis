...
export const SERVICE_VISUALS: Record<string, Record<string, SubcategoryVisual>> = {
  'serwis-laptopow': {
    'naprawy-mechanizm': { icon: SOFTWARE_ICON, software: true },
    'naprawy-karetka': { icon: '/images/naprawy-plyta-glowna-laptop-v6.webp' },
    'naprawy-glowica': { icon: '/images/naprawy-uklad-chlodzenia-v3.webp' },
    'naprawy-tasma': { icon: '/images/accordion-subcategory-dyski-dane.webp' },
    'naprawy-elektronika': { icon: '/images/naprawy-odzyskanie-danych-v2.webp' },
    'naprawy-software': { icon: '/images/accordion-subcategory-ekran-obudowa.webp' },
    'naprawy-dodatkowe': { icon: '/images/accordion-subcategory-klawiatura.webp' },
  },
  'serwis-komputerow-stacjonarnych': {
    'naprawy-mechanizm': { icon: SOFTWARE_ICON, software: true },
    'naprawy-karetka': { icon: '/images/naprawy-plyta-glowna-v3.webp' },
    'naprawy-glowica': { icon: '/images/naprawy-uklad-chlodzenia-v5.webp' },
    'naprawy-tasma': { icon: '/images/accordion-subcategory-dyski-dane.webp' },
    'naprawy-elektronika': { icon: '/images/naprawy-odzyskanie-danych-v2.webp' },
  },
  'serwis-plotterow': {
  ...
  'serwis-drukarek-laserowych': {
    ...
    'naprawy-karetka': { icon: '/images/accordion-icon-laserowe-moduly-obrazu-utrwalania-v2.webp' },
    'naprawy-fuser': { icon: '/images/accordion-icon-modul-utrwalania-fuser.webp' },
    'naprawy-glowica': { icon: '/images/accordion-icon-laser-optyka.webp' },
  ...
  'serwis-drukarek-termicznych': {
    ...
    'naprawy-karetka': { icon: '/images/accordion-icon-termiczne-glowica-platen.webp' },
    'naprawy-glowica': { icon: '/images/accordion-icon-termiczne-czujniki.webp' },
    'naprawy-elektronika': { icon: '/images/accordion-icon-termiczne-ribbon.webp' },
    'naprawy-skaner': { icon: '/images/accordion-icon-termiczne-moduly.webp' },
    'naprawy-software': { icon: '/images/accordion-icon-termiczne-elektronika.webp' },
    'naprawy-additional': { icon: '/images/accordion-icon-termiczne-oprogramowanie-v2.webp' },
  ...
  'serwis-drukarek-iglowych': {
    ...
    'naprawy-karetka': { icon: '/images/accordion-icon-iglowe-glowica.webp' },
    'naprawy-glowica': { icon: '/images/accordion-icon-iglowe-naped-karetki.webp' },
  ...
  'outsourcing-it': {
    'naprawy-mechanizm': { icon: '/images/accordion-icon-outsourcing-serwis-ogolny.webp' },
    'naprawy-karetka': { icon: '/images/accordion-icon-outsourcing-naprawy-sprzetu.webp' },
    'naprawy-glowica': { icon: '/images/accordion-icon-outsourcing-siec-biurowa.webp' },
    'naprawy-tasma': { icon: '/images/accordion-icon-outsourcing-bezpieczenstwo-v2.webp' },
