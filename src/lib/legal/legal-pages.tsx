...
export const regulaminContentRu: LegalPageContent = {
  intro: '«Хотите ознакомиться с нашими Условиями и положениями? Читайте ниже.»',
  title: 'Условия и положения предоставления сервисных услуг Omobonus',
  ...
  sections: [
    {
      ...
      body: (
        <>
          <p className={p}>
            <strong>1.1.</strong> Настоящие Условия и положения (далее «Условия») определяют правила и порядок предоставления услуг по ремонту, диагностике, техническому обслуживанию и других услуг, связанных с компьютерами, принтерами, периферийными устройствами и иным IT-оборудованием, компанией Omobonus Sp. z o.o. (далее «Сервис»).
          </p>
          <p className={p}>
            <strong>1.2.</strong> Услуги предоставляются компанией Omobonus Sp. z o.o., с юридическим адресом: ul. Marcina Bukowskiego 174, 52-418 Wrocław, NIP: 8943160773, KRS: 0000869086, REGON: 387509703, e-mail: <a href="mailto:serwis@omobonus.com.pl" className={link}>serwis@omobonus.com.pl</a>, телефон: <span className={link}>+48 793 759 262</span>.
          </p>
          <p className={p}>
            <strong>1.3.</strong> Каждый Клиент, который пользуется услугами Сервиса, обязан ознакомиться с настоящими Условиями и принять их перед началом предоставления услуг.
          </p>
        </>
      ),
    },
    {
      ...
      body: (
        <ul className={ul}>
          <li><strong>Клиент</strong> — физическое или юридическое лицо, которое пользуется услугами Сервиса.</li>
          <li><strong>Оборудование</strong> — устройства, переданные в Сервис для диагностики, ремонта или технического обслуживания.</li>
          <li><strong>Заказ на ремонт</strong> — форма, заполняемая Клиентом, содержащая данные об оборудовании и описание неисправности.</li>
          <li><strong>Услуга</strong> — все работы, выполняемые Сервисом, включая ремонт, диагностику, установку программного обеспечения, техническое обслуживание и т.п.</li>
        </ul>
      ),
    },
    {
      heading: '3. Правила приёма оборудования в ремонт',
      body: (
        <>
          <p className={p}>
            <strong>3.1.</strong> Сервис принимает оборудование в ремонт только после заполнения формы Заказа на ремонт или обращения через онлайн-систему.
          </p>
          <p className={p}>
            <strong>3.2.</strong> В Заказе на ремонт Клиент обязан указать:
          </p>
          <ul className={ul}>
            <li>полные контактные данные;</li>
            <li>описание проблемы/неисправности;</li>
            <li>серийный номер оборудования;</li>
            <li>данные об оборудовании (марка, модель, конфигурация, техническое состояние);</li>
            <li>информацию о статусе гарантии (если применимо).</li>
          </ul>
          <p className={p}>
            <strong>3.3.</strong> Сервис имеет право отказать в приёме оборудования в ремонт, если:
          </p>
          <ul className={ul}>
            <li>Клиент не предоставил необходимые данные;</li>
            <li>Оборудование ремонтировалось другими лицами или подвергалось самостоятельной модификации, что делает ремонт невозможным.</li>
          </ul>
        </>
      ),
    },
    {
      heading: '4. Сроки выполнения услуг',
      body: (
        <>
          <p className={p}>
            <strong>4.1.</strong> Стандартный срок выполнения ремонта составляет до 30 рабочих дней с момента приёма оборудования в Сервис, если в Заказе на ремонт или с Клиентом не согласовано иное.
          </p>
          <p className={p}>
            <strong>4.2.</strong> В случае необходимости заказа запасных частей или задержек, связанных с поставкой, Сервис обязуется проинформировать Клиента о продлении срока выполнения услуги.
          </p>
          <p className={p}>
            <strong>4.3.</strong> Сервис не несёт ответственности за задержки, возникшие по причине действия обстоятельств непреодолимой силы, например задержек поставок запчастей, сбоев систем, действий производителя оборудования.
          </p>
        </>
      ),
    },
    {
      heading: '5. Гарантия на услуги',
      body: (
        <>
          <p className={p}>
            <strong>5.1.</strong> Сервис предоставляет гарантию на выполненную услугу ремонта или заменённые детали. Срок гарантии обычно составляет 6–12 месяцев, если не согласовано иное.
          </p>
          <p className={p}>
            <strong>5.2.</strong> Гарантия распространяется только на выполненные ремонтные работы и заменённые детали. В случае повреждений, возникших из-за неправильного использования оборудования или вмешательства третьих лиц, Сервис не несёт ответственности.
          </p>
          <p className={p}>
            <strong>5.3.</strong> Гарантия не распространяется на повреждения, возникшие в результате естественного износа деталей, действий в рамках обновления программного обеспечения, а также проблем, возникших по вине пользователя.
          </p>
        </>
      ),
    },
    {
      heading: '6. Ответственность Сервиса',
      body: (
        <>
          <p className={p}>
            <strong>6.1.</strong> Сервис обязуется предоставлять услуги в соответствии с высочайшими стандартами и проявлять надлежащую заботу в процессе ремонта и обслуживания оборудования.
          </p>
          <p className={p}>
            <strong>6.2.</strong> Сервис не несёт ответственности за:
          </p>
          <ul className={ul}>
            <li>потерю данных, файлов, программ на ремонтируемом оборудовании (Клиент должен сделать резервную копию перед передачей оборудования в ремонт);</li>
            <li>косвенные убытки, такие как потеря прибыли, возникшие из-за задержек в ремонте.</li>
          </ul>
          <p className={p}>
            <strong>6.3.</strong> Сервис имеет право отказать в выполнении услуги, если заказанные работы невозможно выполнить из-за повреждений оборудования, делающих его ремонт невозможным.
          </p>
        </>
      ),
    },
    {
      heading: '7. Права и обязанности Клиента',
      body: (
        <>
          <p className={p}>
            <strong>7.1.</strong> Клиент обязуется:
          </p>
          <ul className={ul}>
            <li>предоставить оборудование в надлежащем состоянии для ремонта;</li>
            <li>предоставлять Сервису необходимую информацию о проблемах с устройством;</li>
            <li>информировать Сервис о любых изменениях контактных данных.</li>
          </ul>
          <p className={p}>
            <strong>7.2.</strong> Клиент несёт ответственность за безопасность данных на устройстве. Сервис не отвечает за возможную потерю данных.
          </p>
          <p className={p}>
            <strong>7.3.</strong> Клиент обязуется забрать отремонтированное оборудование в согласованный срок. В противном случае Сервис имеет право начислить дополнительную плату за хранение оборудования.
          </p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          <p className={p}>
            <strong>8.1.</strong> Клиент выражает согласие на обработку его персональных данных в целях выполнения услуг ремонта, связи, а также в маркетинговых целях, если такое согласие было дано.
          </p>
          <p className={p}>
            <strong>8.2.</strong> Сервис обязуется соблюдать действующие нормы законодательства о защите персональных данных, включая GDPR, и обеспечивает безопасность хранения данных.
          </p>
          <p className={p}>
            <strong>8.3.</strong> Клиент имеет право на доступ, исправление, удаление персональных данных и перенос данных в соответствии с действующим законодательством.
          </p>
        </>
      ),
    },
    {
      heading: '9. Цены и оплата',
      body: (
        <>
          <p className={p}>
            <strong>9.1.</strong> Цены на услуги ремонта определяются в зависимости от вида услуги и объёма ремонта. Прайс-лист доступен на сайте Сервиса или в офисе компании.
          </p>
          <p className={p}>
            <strong>9.2.</strong> Оплата услуг производится после завершения ремонта или оказания услуги. Клиент может оплатить наличными, банковским переводом или картой.
          </p>
          <p className={p}>
            <strong>9.3.</strong> В случае невыполнения услуги по вине Клиента (например, если оборудование не было забрано в срок) Сервис имеет право взыскать с Клиента расходы, связанные с хранением оборудования.
          </p>
        </>
      ),
    },
    {
      heading: '10. Претензии',
      body: (
        <>
          <p className={p}>
            <strong>10.1.</strong> Клиент имеет право подать претензию по поводу выполненной услуги в течение 14 рабочих дней с даты получения оборудования.
          </p>
          <p className={p}>
            <strong>10.2.</strong> Претензия должна быть подана в письменной форме или в электронном виде. Сервис рассмотрит претензию в течение 14 рабочих дней.
          </p>
          <p className={p}>
            <strong>10.3.</strong> В случае удовлетворения претензии Сервис обязуется бесплатно устранить недостатки или заменить детали, либо вернуть стоимость услуги.
          </p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          <p className={p}>
            <strong>11.1.</strong> Сервис имеет право вносить изменения в Условия. Изменения вступают в силу после публикации новой версии Условий на сайте Сервиса.
          </p>
          <p className={p}>
            <strong>11.2.</strong> Клиент будет проинформирован об изменениях в Условиях, а продолжение использования услуг после внесения изменений будет считаться принятием новых условий.
          </p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          <p className={p}>
            <strong>12.1.</strong> Условия доступны на сайте Сервиса и могут быть распечатаны или сохранены Клиентом.
          </p>
          <p className={p}>
            <strong>12.2.</strong> Все споры, возникающие в связи с оказанием услуг, будут рассматриваться судом, компетентным по месту нахождения Сервиса.
          </p>
          <p className={p}>
            <strong>12.3.</strong> В случае несоответствия положений Условий действующему законодательству применяются нормы законодательства Польши.
          </p>
        </>
      ),
    },
...
export const politykaPrywatnosciContentRu: LegalPageContent = {
  intro: '«Хотите ознакомиться с нашей Политикой конфиденциальности? Читайте ниже.»',
  ...
  sections: [
    {
      ...
      body: (
        <p className={p}>
          Настоящая Политика конфиденциальности определяет правила обработки и защиты персональных данных,
          предоставленных Пользователями в связи с использованием ими услуг сервиса
          Omobonus Serwis, доступного по адресу <a href="https://serwis.omobonus.com.pl" className={link}>https://serwis.omobonus.com.pl</a>.
        </p>
      ),
    },
    {
      heading: '2. Администратор данных',
      body: (
        <p className={p}>
          Администратором персональных данных является Omobonus Sp. z o.o. с юридическим адресом во Вроцлаве,
          ul. Marcina Bukowskiego 174, 52-418 Wrocław.
        </p>
      ),
    },
    {
      heading: '3. Виды обрабатываемых данных',
      body: (
        <>
          <p className={p}>
          ...
          <ul className={ul}>
            ...
            <li>Данные об устройстве, переданном на сервисное обслуживание</li>
            <li><strong>Данные, собираемые с помощью файлов cookie</strong>, такие как IP-адрес, предпочтения пользователя, данные браузера (если используются).</li>
          </ul>
        </>
      ),
    },
    {
      heading: '4. Цель обработки данных',
      body: (
        <>
          <p className={p}>
          ...
          <ul className={ul}>
            <li>Выполнение сервисных услуг</li>
            <li>Связь с клиентом по вопросу обращения</li>
            <li>Подготовка сметы на ремонт</li>
            <li>Ведение сервисной документации</li>
            <li>Выполнение юридических обязательств</li>
            <li><strong>Анализ статистики сайта и повышение качества услуг</strong> (если используются аналитические инструменты, такие как Google Analytics).</li>
          </ul>
        </>
      ),
    },
    {
      heading: '5. Правовое основание обработки',
      body: (
        <>
          <p className={p}>
          ...
          <ul className={ul}>
            <li>Согласие лица, чьих данных это касается (ст. 6 п. 1 лит. a GDPR)</li>
            <li>Исполнение договора или принятие мер до заключения договора (ст. 6 п. 1 лит. b GDPR)</li>
            <li>Выполнение юридического обязательства (ст. 6 п. 1 лит. c GDPR)</li>
          </ul>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          <p className={p}>
            Персональные данные будут храниться в течение срока, необходимого для достижения целей,
            для которых они были собраны, а также в течение срока, предусмотренного законодательством,
            включая налоговое и бухгалтерское законодательство.
          </p>
          <ul className={`${ul} mt-1.5`}>
            <li>По истечении этого срока данные будут <strong>удалены или анонимизированы</strong>.</li>
          </ul>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          <p className={p}>
            Каждое лицо, чьих данных это касается, имеет право на:
          </p>
          <ul className={ul}>
            <li>Доступ к своим персональным данным</li>
            <li>Исправление (корректировку) данных</li>
    ...
    {
      heading: '8. Передача данных в третьи страны',
      body: (
        <p className={p}>
          Персональные данные могут передаваться в третьи страны в случае использования внешних услуг,
          таких как хранение данных в облаке, аналитические сервисы или интернет-реклама.
          Передача данных осуществляется в соответствии с действующим законодательством, в том числе с использованием
          соответствующих механизмов защиты данных, таких как <strong>стандартные договорные положения</strong>.
        </p>
      ),
    },
    {
      ...
      body: (
        <p className={p}>
          Мы принимаем соответствующие технические и организационные меры для обеспечения безопасности персональных данных.
          Мы используем шифрование данных, защиту от несанкционированного доступа и регулярно обновляем
    ...
    },
    {
      ...
      body: (
        <p className={p}>
          По вопросам, связанным с защитой персональных данных, можно связаться с Администратором
          персональных данных через контактную форму на сайте
          или напрямую по адресу электронной почты: <a href="mailto:serwis@omobonus.com.pl" className={link}>serwis@omobonus.com.pl</a>.
        </p>
      ),
    },
    {
      heading: '11. Обновления политики',
      body: (
        <p className={p}>
          Настоящая Политика конфиденциальности может изменяться. Все изменения будут опубликованы
          на этой странице. Рекомендуем регулярно просматривать содержание политики конфиденциальности.
        </p>
      ),
    },
    {
      heading: '12. Файлы cookie',
      body: (
        <p className={p}>
          На нашем сайте мы используем файлы cookie для сбора информации о предпочтениях пользователей,
          повышения качества услуг, а также для аналитических и маркетинговых целей. Пользователь может управлять
          настройками cookie через свой веб-браузер.
        </p>
      ),
    },
  ],
