    ...
    pricingSections: [
      {
        ...
        items: [
          { service: 'Подготовка к печати', price: '25 zł', duration: '1–2 дня' },
          { service: 'PLA\nстандартный материал для прототипов, моделей и декоративных элементов', price: '0,30 zł/грамм + 8 zł/час', duration: '1–2 дня' },
          { service: 'PETG\nпрочный и влагостойкий, для функциональных и технических деталей', price: '0,35 zł/грамм + 9 zł/час', duration: '1–2 дня' },
          { service: 'ABS / ASA\nпрочные материалы для технических деталей, устойчивых к температуре', price: '0,45 zł/грамм + 12 zł/час', duration: '1–2 дня' },
          { service: 'TPU\nэластичный материал для уплотнителей, накладок и гибких элементов', price: '0,60 zł/грамм + 12 zł/час', duration: '1–2 дня' },
          { service: 'Срочное выполнение\nвыполнение в тот же день, если позволяет время печати', price: '+50%\nк цене', duration: 'до 24 ч' },
          { service: 'Доставка\nкурьером или в постамат', price: 'по тарифу\nперевозчика', duration: 'до 24 ч' },
        ],
      ...
      },
      {
        ...
        items: [
          { service: 'Предварительная оценка проекта\nпроверка возможности выполнения и объёма работ', price: 'БЕСПЛАТНО\nдо 15 мин консультации', duration: 'до 24 ч' },
          { service: 'Небольшая правка файла STL\nизменение размера, отверстия, исправление или мелкая корректировка модели', price: '49 zł\nдо 15 мин работы', duration: 'до 24 ч' },
          { service: 'Простая техническая модель\nна основе размеров, эскиза или чертежа', price: '149 zł\nдо 60 мин работы', duration: '1–2 дня' },
          { service: 'Восстановление простой детали\nпо образцу, фото и точным размерам', price: '199 zł\nдо 90 мин работы', duration: '1–2 дня' },
          { service: 'Технический проект средней сложности\nнапр. корпус, держатель, переходник или более сложный элемент', price: '299 zł\nдо 2 ч работы', duration: '2–3 дня' },
          { service: 'Дополнительная проектная работа\nпосле превышения времени, включённого в выбранную услугу', price: '35 zł\nза каждые дополнительные 15 мин работы', duration: 'по проекту' },
          { service: 'Дополнительный пакет правок\nизменения в готовом проекте после его утверждения', price: '70 zł\nдо 30 мин работы', duration: 'до 24 ч' },
        ],
      },
      {
        id: 'faq',
