    ...
    pricingSections: [
      {
        ...
        items: [
          { service: 'Подготовка к печати', duration: '1–2 дня' },
          { service: 'PLA\nстандартный материал для прототипов, моделей и декоративных элементов', duration: '1–2 дня' },
          { service: 'PETG\nпрочный и влагостойкий, для функциональных и технических деталей', duration: '1–2 дня' },
          { service: 'ABS / ASA\nпрочные материалы для технических деталей, устойчивых к температуре', duration: '1–2 дня' },
          { service: 'TPU\nэластичный материал для уплотнителей, накладок и гибких элементов', duration: '1–2 дня' },
          { service: 'Срочное выполнение\nвыполнение в тот же день, если позволяет время печати', duration: 'до 24 ч' },
          { service: 'Доставка\nкурьером или в постамат', duration: 'до 24 ч' },
        ],
      ...
      },
      {
        ...
        items: [
          { service: 'Предварительная оценка проекта\nпроверка возможности выполнения и объёма работ', duration: 'до 24 ч' },
          { service: 'Небольшая правка файла STL\nизменение размера, отверстия, исправление или мелкая корректировка модели', duration: 'до 24 ч' },
          { service: 'Простая техническая модель\nна основе размеров, эскиза или чертежа', duration: '1–2 дня' },
          { service: 'Восстановление простой детали\nпо образцу, фото и точным размерам', duration: '1–2 дня' },
          { service: 'Технический проект средней сложности\nнапр. корпус, держатель, переходник или более сложный элемент', duration: '2–3 дня' },
          { service: 'Дополнительная проектная работа\nпосле превышения времени, включённого в выбранную услугу', duration: 'по проекту' },
          { service: 'Дополнительный пакет правок\nизменения в готовом проекте после его утверждения', duration: 'до 24 ч' },
        ],
      },
      {
        id: 'faq',
