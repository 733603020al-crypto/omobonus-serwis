  ...
  if (diagnosisIndex !== -1) {
    sections[diagnosisIndex] = {
      ...
      items: [
        ...
        { service: 'PLA', price: '0,30 zł/gram + 8 zł/h', duration: '1–2 dni' },
        { service: 'PETG', price: '0,35 zł/gram + 9 zł/h', duration: '1–2 dni' },
        { service: 'ABS / ASA', price: '0,45 zł/gram + 12 zł/h', duration: '1–2 dni' },
        { service: 'TPU', price: '0,60 zł/gram + 12 zł/h', duration: '1–2 dni' },
