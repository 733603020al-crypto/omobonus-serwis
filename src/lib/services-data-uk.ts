    ...
    pricingSections: [
      {
        ...
        items: [
          { service: 'Підготовка до друку', duration: '1–2 дні' },
          { service: 'PLA\nстандартний матеріал для прототипів, моделей і декоративних елементів', duration: '1–2 дні' },
          { service: 'PETG\nміцний і стійкий до вологи, для функціональних та технічних деталей', duration: '1–2 дні' },
          { service: 'ABS / ASA\nміцні матеріали для технічних деталей, стійких до температури', duration: '1–2 дні' },
          { service: 'TPU\nеластичний матеріал для ущільнювачів, накладок і гнучких елементів', duration: '1–2 дні' },
          { service: 'Термінове виконання\nвиконання того самого дня, якщо дозволяє час друку', duration: 'до 24 год' },
          { service: 'Доставка\nкур\'єром або до поштомату', duration: 'до 24 год' },
        ],
      ...
      },
      {
        ...
        items: [
          { service: 'Попередня оцінка проєкту\nперевірка можливості виконання та обсягу робіт', duration: 'до 24 год' },
          { service: 'Невелика зміна файлу STL\nзміна розміру, отвору, виправлення або дрібне коригування моделі', duration: 'до 24 год' },
          { service: 'Проста технічна модель\nна основі розмірів, ескізу або креслення', duration: '1–2 дні' },
          { service: 'Відтворення простої деталі\nна основі зразка, фото та точних розмірів', duration: '1–2 дні' },
          { service: 'Технічний проєкт середньої складності\nнапр. корпус, тримач, перехідник або складніший елемент', duration: '2–3 дні' },
          { service: 'Додаткова проєктна робота\nпісля перевищення часу, включеного в обрану послугу', duration: 'за проєктом' },
          { service: 'Додатковий пакет правок\nзміни в готовому проєкті після його затвердження', duration: 'до 24 год' },
        ],
      },
      {
        id: 'faq',
