    ...
    pricingSections: [
      {
        ...
        items: [
          { service: 'Підготовка до друку', price: '25 zł', duration: '1–2 дні' },
          { service: 'PLA\nстандартний матеріал для прототипів, моделей і декоративних елементів', price: '0,30 zł/грам + 8 zł/год.', duration: '1–2 дні' },
          { service: 'PETG\nміцний і стійкий до вологи, для функціональних та технічних деталей', price: '0,35 zł/грам + 9 zł/год.', duration: '1–2 дні' },
          { service: 'ABS / ASA\nміцні матеріали для технічних деталей, стійких до температури', price: '0,45 zł/грам + 12 zł/год.', duration: '1–2 дні' },
          { service: 'TPU\nеластичний матеріал для ущільнювачів, накладок і гнучких елементів', price: '0,60 zł/грам + 12 zł/год.', duration: '1–2 дні' },
          { service: 'Термінове виконання\nвиконання того самого дня, якщо дозволяє час друку', price: '+50%\nдо ціни', duration: 'до 24 год' },
          { service: 'Доставка\nкур\'єром або до поштомату', price: 'за прайсом\nперевізника', duration: 'до 24 год' },
        ],
      ...
      },
      {
        ...
        items: [
          { service: 'Попередня оцінка проєкту\nперевірка можливості виконання та обсягу робіт', price: 'БЕЗКОШТОВНО\nдо 15 хв консультації', duration: 'до 24 год' },
          { service: 'Невелика зміна файлу STL\nзміна розміру, отвору, виправлення або дрібне коригування моделі', price: '49 zł\nдо 15 хв роботи', duration: 'до 24 год' },
          { service: 'Проста технічна модель\nна основі розмірів, ескізу або креслення', price: '149 zł\nдо 60 хв роботи', duration: '1–2 дні' },
          { service: 'Відтворення простої деталі\nна основі зразка, фото та точних розмірів', price: '199 zł\nдо 90 хв роботи', duration: '1–2 дні' },
          { service: 'Технічний проєкт середньої складності\nнапр. корпус, тримач, перехідник або складніший елемент', price: '299 zł\nдо 2 год роботи', duration: '2–3 дні' },
          { service: 'Додаткова проєктна робота\nпісля перевищення часу, включеного в обрану послугу', price: '35 zł\nза кожні додаткові 15 хв роботи', duration: 'за проєктом' },
          { service: 'Додатковий пакет правок\nзміни в готовому проєкті після його затвердження', price: '70 zł\nдо 30 хв роботи', duration: 'до 24 год' },
        ],
      },
      {
        id: 'faq',
