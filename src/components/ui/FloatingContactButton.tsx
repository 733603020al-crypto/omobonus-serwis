    ...
    return createPortal(
        <>
            <style>{`
                ...
                .contact-dot-1 { animation: dot1-appear 7.5s ease-in-out infinite; }
                .contact-dot-2 { animation: dot2-appear 7.5s ease-in-out infinite; }
                .contact-dot-3 { animation: dot3-appear 7.5s ease-in-out infinite; }
