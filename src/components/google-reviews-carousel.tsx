                                            ...
                                            <span
                                                ...
                                                className={
                                                    star < Math.floor(review.rating)
                                                        ? "text-[#F4C84A] text-[18px] [text-shadow:-1px_0_0_#8A5A14,1px_0_0_#8A5A14,0_-1px_0_#8A5A14,0_1px_0_#8A5A14,0_0_4px_rgba(255,214,102,0.18)]"
                                                        : "text-[#F4C84A]/25 text-[18px]"
                                                }
                                            >
                                                {"★"}
                                            </span>
