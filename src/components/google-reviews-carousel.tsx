                                            ...
                                            <span
                                                ...
                                                className={
                                                    star < Math.floor(review.rating)
                                                        ? "text-[#F6C344] text-[18px] [text-shadow:-0.5px_0_0_#A66A00,0.5px_0_0_#A66A00,0_-0.5px_0_#A66A00,0_0.5px_0_#A66A00,0_1px_1px_rgba(80,45,0,0.20)]"
                                                        : "text-[#F6C344]/25 text-[18px]"
                                                }
                                            >
                                                {"★"}
                                            </span>
