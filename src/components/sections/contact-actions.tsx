      ...
      <section className="mx-auto max-w-2xl px-4 pt-8 pb-4 md:pt-10 md:pb-6">
        ...
        <div className="mb-6 flex flex-row items-start justify-center gap-5 md:gap-7 md:mb-8">
          <a
            ...
            className="flex flex-col items-center gap-1 transition-all duration-300 ease-out hover:-translate-y-1"
          >
          ...
          <a href="mailto:serwis@omobonus.com.pl" className="flex flex-col items-center gap-1 transition-all duration-300 ease-out hover:-translate-y-1">
          ...
          <a href="https://wa.me/48793759262" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 transition-all duration-300 ease-out hover:-translate-y-1">
          ...
          <a href="https://t.me/+48793759262" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 transition-all duration-300 ease-out hover:-translate-y-1">
          ...
          <a href="viber://chat?number=%2B48793759262" className="flex flex-col items-center gap-1 transition-all duration-300 ease-out hover:-translate-y-1">
