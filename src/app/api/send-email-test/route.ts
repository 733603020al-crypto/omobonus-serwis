...
export async function GET() {
  try {
    ...
    const backgroundImagePath = path.join(process.cwd(), 'public', 'images', 'zmiety arkusz papieru 2.webp')
    // Путь к логотипу
    const logoImagePath = path.join(process.cwd(), 'public', 'images', 'Logo_Omobonus.webp')
